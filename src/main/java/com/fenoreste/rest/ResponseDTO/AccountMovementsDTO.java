...
public class AccountMovementsDTO {
    ...
    public String toString() {
        return "GetAccountMovementsDTO{" + "MovementId=" + MovementId + ", AccountBankIdentifier=" + AccountBankIdentifier + ", MovementDate=" + MovementDate + ", Description=" + Description + ", Amount=" + Amount + ", isDebit=" + isDebit + ", Balance=" + Balance + ", MovementTypeId=" + MovementTypeId + ", TypeDescription=" + TypeDescription + ", CheckId=" + CheckId + ", VoucherId=" + VoucherId + '}';
    }
